...
/**
 * This is the extension manager of the Wsclientgenerator extension.
 */
public class WsclientgeneratorManager extends GeneratedWsclientgeneratorManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WsclientgeneratorManager.class.getName());
	 ...
	 */
	public static WsclientgeneratorManager getInstance()
	{
		return (WsclientgeneratorManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WsclientgeneratorConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WsclientgeneratorManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WsclientgeneratorManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WsclientgeneratorManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WsclientgeneratorManager called, current tenant: " + getTenant().getTenantID());
		}
	}
