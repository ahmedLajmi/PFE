 ...
 *
 */
package de.hybris.platform.addons.wsclientgenerator.hmc;
...
/**
 * Provides necessary meta information about the wsclientgenerator hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.1
 */
public class WsclientgeneratorHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(WsclientgeneratorHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.addons.wsclientgenerator.hmc.locales";
