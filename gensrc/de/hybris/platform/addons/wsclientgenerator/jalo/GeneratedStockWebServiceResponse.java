...
/**
 * Generated class for type {@link de.hybris.platform.jalo.GenericItem StockWebServiceResponse}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedStockWebServiceResponse extends WebServiceParameter
{
	/** Qualifier of the <code>StockWebServiceResponse.value</code> attribute **/
	public static final String VALUE = "value";
	/** Qualifier of the <code>StockWebServiceResponse.customerConfiguration</code> attribute **/
	...
	**/
	protected static final BidirectionalOneToManyHandler<GeneratedStockWebServiceResponse> CUSTOMERCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler<GeneratedStockWebServiceResponse>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>StockWebServiceResponse.customerConfiguration</code> attribute.
	 * @return the customerConfiguration
	 */
	public StockWebServiceConfiguration getCustomerConfiguration(final SessionContext ctx)
	{
		return (StockWebServiceConfiguration)getProperty( ctx, CUSTOMERCONFIGURATION);
	}
	 ...
	 * @return the customerConfiguration
	 */
	public StockWebServiceConfiguration getCustomerConfiguration()
	{
		return getCustomerConfiguration( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>StockWebServiceResponse.customerConfiguration</code> attribute. 
	 * @param value the customerConfiguration
	 */
	public void setCustomerConfiguration(final SessionContext ctx, final StockWebServiceConfiguration value)
	{
	 ...
	 * @param value the customerConfiguration
	 */
	public void setCustomerConfiguration(final StockWebServiceConfiguration value)
	{
		setCustomerConfiguration( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>StockWebServiceResponse.value</code> attribute.
	 * @return the value
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>StockWebServiceResponse.value</code> attribute. 
