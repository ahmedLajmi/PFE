...
/**
 * Generated class for type {@link de.hybris.platform.jalo.GenericItem OrderWebServiceResponse}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedOrderWebServiceResponse extends WebServiceParameter
{
	/** Qualifier of the <code>OrderWebServiceResponse.value</code> attribute **/
	public static final String VALUE = "value";
	/** Qualifier of the <code>OrderWebServiceResponse.customerConfiguration</code> attribute **/
	...
	**/
	protected static final BidirectionalOneToManyHandler<GeneratedOrderWebServiceResponse> CUSTOMERCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler<GeneratedOrderWebServiceResponse>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>OrderWebServiceResponse.customerConfiguration</code> attribute.
	 * @return the customerConfiguration
	 */
	public OrderWebServiceConfiguration getCustomerConfiguration(final SessionContext ctx)
	{
		return (OrderWebServiceConfiguration)getProperty( ctx, CUSTOMERCONFIGURATION);
	}
	 ...
	 * @return the customerConfiguration
	 */
	public OrderWebServiceConfiguration getCustomerConfiguration()
	{
		return getCustomerConfiguration( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>OrderWebServiceResponse.customerConfiguration</code> attribute. 
	 * @param value the customerConfiguration
	 */
	public void setCustomerConfiguration(final SessionContext ctx, final OrderWebServiceConfiguration value)
	{
	 ...
	 * @param value the customerConfiguration
	 */
	public void setCustomerConfiguration(final OrderWebServiceConfiguration value)
	{
		setCustomerConfiguration( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>OrderWebServiceResponse.value</code> attribute.
	 * @return the value
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>OrderWebServiceResponse.value</code> attribute. 
